...
const char* ssid = "Nguyen Toi"; //Đổi thành wifi của bạn
const char* password = "11111111"; //Đổi pass luôn
const char* ip_host = "192.168.0.106"; //Đổi luôn IP host của PC nha
